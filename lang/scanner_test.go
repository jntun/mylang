...
func TestScanClass(t *testing.T) {
	...
	expectedTokens := []Token{
		...
		Token{"getName", Identifier, 6},
		Token{"(", LeftParen, 6},
		Token{")", RightParen, 6},
		Token{"{", LeftBrace, 6},
		Token{"return", Return, 7},
		Token{"hello world!", String, 7},
		Token{";", Semicolon, 7},
		Token{"}", RightBrace, 8},
		Token{"func", Function, 10},
		Token{"nothing", Identifier, 10},
		Token{"(", LeftParen, 10},
		Token{"x", Identifier, 10},
		Token{",", Comma, 10},
		Token{"y", Identifier, 10},
		Token{")", RightParen, 10},
		Token{"{", LeftBrace, 10},
		Token{"}", RightBrace, 10},
		Token{"}", RightBrace, 11},
		Token{"var", Var, 13},
		Token{"test", Identifier, 13},
		Token{"=", Equal, 13},
		Token{"Test", Identifier, 13},
		Token{"(", LeftParen, 13},
		Token{")", RightParen, 13},
